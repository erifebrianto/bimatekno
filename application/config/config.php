...
|
*/
$config['base_url'] = 'http://localhost/bimatekno';
...
$config['hostname_mikrotik'] = '103.143.170.203'; // Ganti dengan IP MikroTik Anda
$config['username_mikrotik'] = 'api';   // Ganti dengan username MikroTik Anda
$config['password_mikrotik'] = 'api';   // Ganti dengan password MikroTik Anda
$config['port_mikrotik']     = 8728;         // Port default API MikroTik
*/